        ...
        return (
            <div>
                ...
                <div className="profile-container">
                    ...
                    <u> {this.state.currentContact.phoneNumber? this.state.currentContact.phoneNumber : <div> no phone number</div> }</u>
                    </div>
                    
                    <div className="smallerText">EMAIL</div>
                    <div className="userText">
                        <u> {this.state.currentContact.email ? this.state.currentContact.email : <div> no email</div> }</u>
                    </div>
                    <div className="smallerText">DESCRIPTION</div>
                    <div className="userText">{this.state.currentContact.description ? this.state.currentContact.description : <div> no description</div> }</div>
                </div>
